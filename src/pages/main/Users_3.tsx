...
class Users_3 extends BaseModel {
  public id: string = '';
...
class Users_3CRUDState extends CrudTableState<Users_3> {
  public axios: any | undefined = instance;
  public endpoint: string = 'users_3';
...
export default class Users_3CRUD extends CrudTable<any, Users_3CRUDState> {
  constructor(props: any) {
    super(props, Users_3CRUDState);
