...
class Users_2 extends BaseModel {
  public id: string = '';
  public unique: string = '';
}
class Users_2CRUDState extends CrudTableState<Users_2> {
  public axios: any | undefined = instance;
  public endpoint: string = 'users_2';
...
export default class Users_2CRUD extends CrudTable<any, Users_2CRUDState> {
  constructor(props: any) {
    super(props, Users_2CRUDState);
